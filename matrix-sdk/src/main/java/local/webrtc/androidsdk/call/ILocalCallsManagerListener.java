 ...
 */
public interface ILocalCallsManagerListener {
    /**
     ...
     */
    void onIncomingCall(ILocalCall call, MXUsersDevicesMap<MXDeviceInfo> unknownDevices);
     ...
     */
    void onOutgoingCall(ILocalCall call);
     ...
     * @param call the incoming call
     */
    void onCallHangUp(ILocalCall call);
